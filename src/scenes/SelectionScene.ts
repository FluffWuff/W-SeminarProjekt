...
export class SelectionScene extends Phaser.Scene {
    ...
    create() {
        ...
        let tutorial = new GeneralButton(this, (1920/2)-1, 800, "Tutorial", () => {
            window.open("https://www.youtube.com/watch?v=zNdBR-yp3TI")
        }, 58)

        let sourceCode = new GeneralButton(this, (1920/2)-1, 900, "Source", () => {
            window.open("https://github.com/FluffWuff/W-SeminarProjekt")
        })
    }
